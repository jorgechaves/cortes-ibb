# Spec: booklet-generator

## Purpose

Gera um livreto A5 em PDF a partir do transcript de um job, aplicando correção ortográfica via OpenAI e seguindo o template visual de `modelo_livreto.pdf` (capa azul-marinho com barras douradas, páginas de conteúdo com cabeçalho e linha dourada, contracapa azul-marinho).
